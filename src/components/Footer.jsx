  ...
  return (
    <>
        <footer className="bg-base-200 text-base-content p-10">
            <div className="footer sm:footer-horizontal flex flex-wrap justify-between">
                {/* Logo & Address */}
                <aside className="w-full md:w-1/4 flex flex-col items-start">
                    <img src="/assets/Logo.png" alt="Logo" className="w-70 h-auto mb-4" />
                ...
                <nav className="w-full md:w-1/5">
                    ...
                    <a className="link link-hover">Digital & Teknologi</a>
                    <a className="link link-hover">Pemasaran</a>
                    <a className="link link-hover">Manajemen Bisnis</a>
                    <a className="link link-hover">Pengembangan Diri</a>
                ...
                {/* Komunitas */}
                <nav className="w-full md:w-1/5">
                    <h6 className="footer-title">Komunitas</h6>
                    <a className="link link-hover">Tips Sukses</a>
            ...
            <div className="footer flex flex-col md:flex-row justify-between items-center p-4">
